...
const Navbar = async (props:Props) => {
  ...
  return (
    ...
    backdrop-blur-lg z-[100] flex items-center border-b-[1px] border-neutral-900 justify-between'>
        <aside className='flex items-center gap-[2px]'>
            <p className='text-3xl font-bold'>Fusion</p>
            <Image
            src = '/fuzzieLogo.png'
            width ={15}
            height={15}
        ...
        <aside className='flex items-center gap-4'>
          ...
          >
            ...
            bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)]'></span>
