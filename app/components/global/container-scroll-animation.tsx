...
export const ContainerScroll = ({
  ...
  const rotate = useTransform(scrollYProgress, [0, 1], [25, 0.1])
  const scale = useTransform(scrollYProgress, [0, 0], scaleDimensions())
    ...
    >
      <div className="bg-gray-100 h-full w-full rounded-2xl gap-4 overflow-hidden p-4 transition-all ">
        <Image
          ...
          fill
          alt="bannerImage"
          className="object-cover border-8 rounded-2xl bg-neutral-800"
        />
      </div>
    </motion.div>
  )
