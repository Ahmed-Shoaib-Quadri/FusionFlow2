...
export default function Home() {
  return (
    <main>
      <Navbar />
      <section className="h-screen w-full bg-neutral-950 rounded-md !overflow-visible 
        ...
        <div className="flex flex-col mt-[-100px] md:mt-[-50px]">
          ...
          titleComponent = {
            ...
            flex-col">
              ...
              justify-center gap-4 hover:shadow-xl
              ...
              text-transparent bg-gradient-to-b from-white to-neutral-600  font-sans font-bold">
                Automate Your Work With FusionFlow
              </h1>
            </div>
          }
          />
            ...
            w-full md:!w-[350px] h-auto rounded-xl p-6 border">
              ...
              <div className="flex justify-between items-center mt-8">
                ...
                <CardItem
                 ...
                 dark:text-black text-white text-xs font-bold cursor-pointer"
                >
                  Get Started Now
                </CardItem>
              </div>
